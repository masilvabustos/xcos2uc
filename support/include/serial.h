...
/* This is temporal, Should be fixed */
//#include "platform.h"
#define HAS_UART_DMA
...
void stm32f10x_reset_serial_port(struct serial_port*);
void stm32f10x_setup_serial_port(struct serial_port*);
...
int stm32f10x_serial_tx_complete(serial_port_t);
int stm32f10x_serial_tx_ready(serial_port_t);
...
#define serial_tx_complete stm32f10x_serial_tx_complete
#define serial_tx_ready stm32f10x_serial_tx_ready
#endif
